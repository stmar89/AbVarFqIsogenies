...
//The following shows a bug for GraphOverOrders https://magma.maths.usyd.edu.au/magma/handbook/text/455#4979
...
f:=WeilPolynomial(L); //needs a function
//f:=x^4-2*x^2+121;
g,q,p:=Getgqp(f);
g,q,p;
...
GraphOverOrders(R); //This has no edges although you can check them by hand and they do have relations. 

*/


//The following is a fix for GraphOverOrders.
